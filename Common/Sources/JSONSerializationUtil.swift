...
public class JSONSerializationUtil {
    ...
    public static func deserializeResponse(response: URLResponse, responseData: Data) -> [String: Any]? {
    ...
    public static func serializeObjectToJSONData(object: Any?) -> Data {
        if object == nil {
            return Data()
        }
    ...
    public static func serializeObjectToJSONString(object: Any?) -> String {
